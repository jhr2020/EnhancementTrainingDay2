...
sap.ui.define([
	...
	function (
		...
		"use strict";
		return ControllerExtension.extend("customer.ztrai.jhr.adaptation.template.training2.CustomExtension", {
			// metadata: {
			...
			// 	 * @memberOf customer.ztrai.jhr.adaptation.template.training2.CustomExtension
			// 	 */
			// 	onInit: function() {
			// 	},
			 ...
			 */
				addFilters: function(fnAddFilter, sControlId){
					var sSelectedKey = this.byId("CustomFilter").getSelectedKey(),
						oFilter;
